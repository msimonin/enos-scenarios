...
* Adrien - Proposal/questions
[ ] How can we remove debug/verbose information?
Plan de TP (pour aider si y'a deja des trucs tout pret pas de souci pour avancer sur les trucs tout pret ;)
1./ il cree la vm via l’interface horizon
2./ via la commande line et il joue  un peu
3./ via rally et il regarde les traces
4./ avec shaker et il regarde les traces
  => Matt: Shaker c'est long
  [ ] Est ce qu'on peut prendre un bout de code de shaker et faire notre propre script de customization qui se joue dans une cirros?
5./ topology plus rude avec TC
