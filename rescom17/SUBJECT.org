...
** Control plane Benchmarking with Rally
TODO: Control plane meaning.

: vagrant@enos-node:/opt/enos$ enos bench --workload=workload

See the complete list of scenarios[fn:rally-scenarios].
...
** Data plane Benchmarking with Shaker
